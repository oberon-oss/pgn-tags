...
class TagCreatorStringValueTest {
    @Test
    void testWithValidValuesNoAllowingMissingValues() {
        TagCreator<String, String> creator = TagCreatorStringValue.getInstance("int-1", false, false);
        PgnTag<String> tag;
    ...
    void testWithValidValuesAllowMissingValues() {
        TagCreator<String, String> creator = TagCreatorStringValue.getInstance("int-1", true, false);
        PgnTag<String> tag;
